...
export default function AboutMe() {
    const aboutBody = (
        <>
            ...
            <br/>
            <p>In addition, I am a Computer Science Tutor, offering tailored one-to-one sessions for students up to A Level or equivalent, covering topics such as programming, data structures, amdorithms, and web development. I have a passion for teaching and mentoring, and I have helped many students achieve their academic goals and improve their coding skills. </p>
            <br/>
