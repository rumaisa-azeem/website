...
export default function Window({children, className, bgColor}) {
    return (
        <div className={`rounded-lg border-2 border-gray-500 p-2 drop-shadow-lg flex flex-col gap-3 ${className} ${bgColor ? bgColor : "bg-pink-200"}`}>
